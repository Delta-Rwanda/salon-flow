        ...
        <div className="flex flex-col justify-center items-start">
          <div className="flex flex-row justify-center items-center gap-2">
            <Link
              ...
              target="_blank"
              className="bg-[#F8F9FA] p-1 rounded text-sm"
            >
              <FaFacebookF />
            </Link>
            <Link
              ...
              target="_blank"
              className="bg-[#F8F9FA] rounded text-sm w-5 text-center"
            >
              𝕏
            </Link>
            <Link
        ...
        <div className="flex flex-col justify-center items-start">
          ...
          <form className="flex justify-center bg-[#9894B1] rounded-md">
            <input
              ...
              className="px-4 py-2 rounded-l-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm w-full sm:w-60"
            />
            <button
              type="submit"
