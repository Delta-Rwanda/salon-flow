      ...
      <div className="w-full max-w-md">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            <label
              htmlFor="email"
              className="block text-[16px] font-poppins font-regular text-gray-700 mb-1"
            >
              Email
            </label>
            <input
          ...
          <div className="flex justify-start mb-6">
            <a
              href="#"
              className="text-xl font-poppins font-semibold text-gray-600 hover:text-gray-800"
            >
        ...
        <div className="flex items-center my-6">
          ...
          <span className="px-4 text-[16px] text-gray-500 font-poppins font-semibold">
            OR
          </span>
          <div className="flex-grow border-t border-gray-300"></div>
        </div>
