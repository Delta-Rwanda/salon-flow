...
const LogIn = () => {
  ...
  return (
    <>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <InputField
                ...
                className={`w-full px-3 py-2 text-sm border ${errors.email ? 'border-red-500' : 'border-gray-300'} rounded-md focus:outline-none focus:ring-2 focus:ring-[#505050] bg-[#F4F4F4]`}
              />
              {errors.email && (
            ...
            <div>
              ...
              <InputField
                ...
                className={`w-full px-3 py-2 text-sm border ${errors.password ? 'border-red-500' : 'border-gray-300'} rounded-md focus:outline-none focus:ring-2 focus:ring-[#505050] bg-[#F4F4F4]`}
              />
              {errors.password && (
      ...
      <div className="bg-[#F4F4F4] flex flex-wrap items-center justify-center px-4 py-6 w-full">
        <p className="max-w-[904px] w-full text-center text-sm sm:text-base text-[#505050] font-light leading-6">
